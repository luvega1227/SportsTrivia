...
class ViewController: UIViewController {
    ...
    // First loaded generated question per current index on array (currentQuestionIndex)
    ...
    //"Show Next Question" function when user presses button
    @IBAction func showNextQuestions(sender: AnyObject) {
        ...
        // questionLabel being changed per currentQuestionIndex
        let question: String = questions[currentQuestionIndex]
        questionLabel.text = question
        answerLabel.text = "???"
    }
    
    // "Show Answer" function when user presses button
